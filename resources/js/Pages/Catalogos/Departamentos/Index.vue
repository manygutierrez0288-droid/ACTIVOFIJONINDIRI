...
const submitForm = () => {
    if (isEditing.value) {
        form.put(route('departamentos.update', itemId.value), {
...
const deleteItem = () => {
    router.delete(route('departamentos.destroy', itemToDelete.value), {
        onSuccess: () => {
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                    ...
                    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                <tr v-for="item in departamentos.data" :key="item.id" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
        ...
        <Modal :show="showingModal" @close="closeModal">
            <div class="p-6">
                ...
                <form @submit.prevent="submitForm" class="mt-6 space-y-6">
                    <div>
                        <InputLabel for="nombre" value="Nombre del Departamento" />
                        <TextInput
                            id="nombre"
                            type="text"
