...
const submitForm = () => {
    if (isEditing.value) {
        form.put(route('cargos.update', itemId.value), {
...
const deleteItem = () => {
    router.delete(route('cargos.destroy', itemToDelete.value), {
        onSuccess: () => {
...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Cargos</h2>
        </template>
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                    ...
                    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                <tr v-for="item in cargos.data" :key="item.id" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
        ...
        <Modal :show="showingModal" @close="closeModal">
            <div class="p-6">
                ...
                <form @submit.prevent="submitForm" class="mt-6 space-y-6">
                    <div>
                        <InputLabel for="nombre" value="Nombre del Cargo" />
                        <TextInput
                            id="nombre"
                            type="text"
