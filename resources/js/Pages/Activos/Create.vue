...
const submit = () => form.post(route('activos.store'));
</script>

<template>
    <Head title="Crear Activo Fijo" />
    <AuthenticatedLayout>
        <template #header><h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Crear Activo Fijo</h2></template>
        <div class="py-12"><div class="max-w-7xl mx-auto sm:px-6 lg:px-8"><div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6">
            <form @submit.prevent="submit" class="space-y-6">
                ...
                <div class="flex justify-end mt-6 pt-6 border-t dark:border-gray-700">
                    ...
                    <PrimaryButton :disabled="form.processing">Crear Activo</PrimaryButton>
                </div>
            </form>
        </div></div></div>
    </AuthenticatedLayout>
