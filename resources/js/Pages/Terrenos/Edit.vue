...
const form = useForm({
    nombre: props.terreno.activo_fijo?.nombre || '',
    imagen: null,
    categoria_id: props.terreno.activo_fijo?.categoria_id || '',
    departamento_id: props.terreno.activo_fijo?.departamento_id || '',
    ubicacion_id: props.terreno.activo_fijo?.ubicacion_id || '',
    marca_id: props.terreno.activo_fijo?.marca_id || '',
    modelo_id: props.terreno.activo_fijo?.modelo_id || '',
    fuente_id: props.terreno.activo_fijo?.fuente_id || '',
    proveedor_id: props.terreno.activo_fijo?.proveedor_id || '',
    responsable_id: props.terreno.activo_fijo?.responsable_id || '',
    estado_id: props.terreno.activo_fijo?.estado_id || '',
    fecha_adquisicion: props.terreno.activo_fijo?.fecha_adquisicion || '',
    valor_adquisicion: props.terreno.activo_fijo?.valor_adquisicion || '',
    vida_util_anios: props.terreno.activo_fijo?.vida_util_anios || 0,
    valor_residual: props.terreno.activo_fijo?.valor_residual || '',
    numero_serie: props.terreno.activo_fijo?.numero_serie || '',
    codigo_inventario: props.terreno.activo_fijo?.codigo_inventario || '',
    // Terreno specific fields
    numero_escritura: props.terreno.numero_escritura || '',
    area_metros_cuadrados: props.terreno.area_metros_cuadrados || '',
    frente_metros: props.terreno.frente_metros || '',
    fondo_metros: props.terreno.fondo_metros || '',
    lindero_norte: props.terreno.lindero_norte || '',
    lindero_sur: props.terreno.lindero_sur || '',
    lindero_este: props.terreno.lindero_este || '',
    lindero_oeste: props.terreno.lindero_oeste || '',
    coordenadas_gps: props.terreno.coordenadas_gps || '',
    uso_suelo: props.terreno.uso_suelo || '',
    zonificacion: props.terreno.zonificacion || '',
    valor_catastral: props.terreno.valor_catastral || '',
});
...
const submit = () => form.post(route('terrenos.update', props.terreno.id));
</script>

<template>
    <Head title="Editar Terreno" />
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center gap-4">
                ...
                <h2 class="font-bold text-2xl text-gray-900 dark:text-white leading-tight">Editar Terreno</h2>
            </div>
        </template>
        ...
        <div class="max-w-5xl mx-auto pb-12">
            <form @submit.prevent="submit" class="space-y-8">
                ...
                <div class="flex items-center justify-end gap-4 p-6 bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700">
                    ...
                    >
                        {{ form.processing ? 'Actualizando...' : 'ACTUALIZAR TERRENO' }}
                    </PrimaryButton>
                </div>
